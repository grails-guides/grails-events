...
This repository contains the worked sample app for the [Grails Events](https://grails.apache.org/guides/grails-events/4/guide/index.html) guide on the Apache Grails site.
